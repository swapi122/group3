<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMana.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:TextBox ID="txtId" runat="server" ontextchanged="TextBox1_TextChanged" 
